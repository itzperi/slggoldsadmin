                ...
                <div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
                    ...
                    <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
                        ...
                        <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight text-foreground mb-8 leading-[1.05]">
                            ...
                            <span className="text-primary">with Gold & Silver.</span>
                        </h2>

                        {/* Description */}
                        <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
                            Secure. Trusted. Flexible Investment Schemes for Your Future.
                            Join thousands of investors growing their legacy with SLG Golds.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button className="h-14 items-center justify-center gap-3 rounded-full border border-input bg-background hover:bg-accent hover:text-accent-foreground px-12 text-base font-medium transition-all">
                                How it Works
                            </button>
                        </div>
                    </div>
